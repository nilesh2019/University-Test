	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="diskSpaceAllocationFrm" enctype="multipart/form-data" action="#" role="form" method="post">
					...
					<div id="diskSpaceAllocationFormFields" class="form-group  mgbt-xs-20">
						...
						<div class="col-md-12">
							...
							<div class="vd_input-wrapper light-theme" id="users-input-wrapper">
					...
					<div class="form-group">
						...
						<div class="col-md-12 text-center mgbt-xs-5">
							...
							<button class="btn vd_btn vd_btn-bevel vd_bg-blue font-semibold width-100" type="submit" id="diskSpaceAllocation-submit">
