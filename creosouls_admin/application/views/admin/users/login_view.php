...
<head>
    <meta charset="utf-8" />
    <title>Creosouls Admin Login Page</title>
    <!-- Set the viewport width to device width for mobile -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">


    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="<?php echo front_base_url();?>assets/img/favicon.png">
          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                <h4 class="text-center font-semibold vd_grey">Login to creosouls admin account</h4>
              </div>
              <div class="panel widget">
                <div class="panel-body">
                  <div class=""><img height="50" src="<?php echo front_base_url();?>assets/images/logo.png" style="margin-bottom: 20px;" alt="logo"></div>
            ...
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright text-center">
                    Copyright &copy;2017 creosouls All Rights Reserved
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
