         ...
         <div class="vd_head-section clearfix">
          <div class="vd_panel-header">
            <ul class="breadcrumb">
              ...
              <li class="active">Check Enroll Student</li>
            </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="panel widget">
              <div class="panel-heading vd_bg-grey">
                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Check Enroll Student</h3>
              </div>
              <div class="panel-body" style="border: 1px solid #eee;">
                <form method='POST' id="check_enroll_student" action='check_enroll_student'>
                  <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-12">
                        <button class="btn btn-primary check_enroll_student" type="button" id="institute-submit">Submit</button>
                      </div>
                    </div>
                  </div>
                </form>
  ...
  <script type="text/javascript" language="javascript" >
    $(document).ready(function() {
      $('.studentid').keypress(function (e) {
          if (e.which == 13) {
           $('.check_enroll_student').trigger('click');
            return false;    //<---- Add this line
          }
        });
        $(document).on('click','.check_enroll_student',function(){
          var form = '#'+$(this).parents('form').attr('id');
          var url = $(form).attr('action');
          var serialize_data = $(form).serialize();
          $.ajax({
              type:'POST',
              url:'<?php echo base_url();?>'+'admin/enroll_users/check_enroll_student', 
              dataType:'html',
              data:serialize_data,
