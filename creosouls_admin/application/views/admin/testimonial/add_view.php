             ...
             <div class="modal-dialog">
                 ...
                 <div class="modal-content">
                   ...
                   <div class="modal-header vd_bg-blue vd_white">
                      ...
                      <h4 id="myModalLabel" class="modal-title">Add New Testimonial</h4>
                 ...
                 <div class="alert alert-success vd_hidden">
                   ...
                   <div id="jobFormFields" class="form-group  mgbt-xs-20">
                     ...
                     <div class="col-md-12">
                       ...
                       <label class="control-label" for="title">Company/ Designation</label> (<span class="requiredClass"> * </span>)

                       </div>

                       <div class="vd_input-wrapper light-theme" id="title-input-wrapper"> <span class="menu-icon"> <i class="fa fa-envelope"></i> </span>

                         <input type="text" placeholder="Company/ Designation" id="designation" name="designation" class="required">
                       ...
                       <div class="label-wrapper">
                         ...
                         <label class="control-label " for="message">Message</label> (<span class="requiredClass"> * </span>)

                       </div>

                       <div class="vd_input-wrapper light-theme">

                        <textarea id="wysiwyghtml" name="message" class="width-100 form-control"  rows="15" placeholder="Write your message here"></textarea>
