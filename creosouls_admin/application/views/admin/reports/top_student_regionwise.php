         ...
         <!--  <div class="vd_title-section clearfix">
          ...
          <div class="vd_title-section clearfix ">
            <div class="panel widget report_div">
              <div class="panel-heading vd_bg-grey">
                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Region Wise Top 5 Student</h3>
               <!--  <a href="<?php echo base_url();?>admin/reports/export_topstudent_regionwise" class="btn btn-info btn-sm pull-right" style="margin-top: -25px;"><i class="icon-export"> <span style="font-family:'Open Sans','arial'">Export Region Wise Top 5 Student</span></i></a> -->
              </div>
                ...
                if(isset($top_student) && !empty($top_student)){?>
                  <table id="example" class="display masterTable dataTable no-footer" cellspacing="0" width="100%">
                    ...
                    if(isset($top_student) && !empty($top_student))
                    {
                        ...
                        ?>
                           <tr>
                              <td style="font-size: 14px"><b><?php echo (isset($region->region_name) && !empty($region->region_name))?$region->region_name:''; ?></b></td>
                              <td colspan="5"></td>
                            </tr>
                          <?php 
                          $i=0;
                          foreach ($stddata as $key) { $i++; 
                          ?>
                          <tr>
                            <td><?php echo $i; ?></td>
