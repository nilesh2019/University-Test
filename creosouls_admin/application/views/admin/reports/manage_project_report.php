         ...
         <div class="vd_head-section clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="panel widget">
              <div class="panel-heading vd_bg-grey">
                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Project Report</h3>
              </div>
          ...
          <div class="vd_title-section clearfix ">
            <div class="panel widget report_div">
              <div class="panel-heading vd_bg-grey">
                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Project Report Table</h3>
               <!--  <a href="<?php echo base_url();?>admin/reports/exportinstitutedata/<?php echo (isset($start_date) && !empty($start_date))?$start_date:''; ?>/<?php echo (isset($end_date) && !empty($end_date))?$end_date:''; ?>/<?php echo (isset($institute_status) && !empty($institute_status))?$institute_status:''; ?>" class="btn btn-info btn-sm pull-right" style="margin-top: -25px;"><i class="icon-export"> <span style="font-family:'Open Sans','arial'">Export Projects To CSV</span></i></a> -->
              </div>
  ...
  <script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        $(document).on('change','.getregion_list',function(){
          ...
          $.ajax({
              type:'POST',
              url:'<?php echo base_url();?>'+'admin/reports/getZoneRegionList', 
              dataType:'html',
              data:{zoneId:zoneId},
              success:function(data)
              { 
