          ...
          <div class="vd_title-section clearfix">
            <div class="panel widget">
              <div class="panel-heading vd_bg-grey">
                <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Student Report</h3>
              </div>
              <div class="panel-body" style="border: 1px solid #eee;">
                <form method='POST' id="student_report" action='student_report'>
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="vd_input-wrapper light-theme" id="instituteName-input-wrapper"> 
                        <select  class="form-control getregion_list" name="zone" id="zone">
                          ...
                          { 
                            foreach($zoneData as $zon){  ?>
                            <option value="<?php echo $zon->id;?>"><?php echo $zon->zone_name;?></option>
                         <?php  } 
                          }?>
                        </select>
                      </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="vd_input-wrapper light-theme">
                        <select  class="form-control setins_list" name="institute_id" id="institute_id">
                          <option value="All" >All</option>
                          <?php if(!empty($instituteData))
                          { 
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="label-wrapper ">
                        <label class="control-label" for="instituteName">Select Student Status</label>
                      </div>
                      <div class="vd_input-wrapper light-theme" id="instituteName-input-wrapper"> 
                    ...
                    <tbody> 
                      ...
                      foreach ($studentData as $key) { $i++; ?>
                        <tr>
                          ...
                          <td><?php echo $key->first_login_date; ?></td>
                          <td><?php echo $key->project_cnt; ?></td>
                        </tr>
                      <?php } ?>  
                    </tbody>
                  </table>
...
<?php $this->load->view('admin/template/footer');?>
  ...
  <script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        $(document).on('change','.setregion_list',function(){
          var regionid = $(this).val();
          $.ajax({
              async: true,
              type:'POST',
              url:base_url+'admin/reports/getinsList', 
              dataType:'html',
              data:{regionid:regionid},
              success:function(data)
              { 
                $('.setins_list').html(data);
              }
          });
        });
       /* $(document).on('click','.show_report',function(){
          ...
          $.ajax({
              type:'POST',
              url:'<?php echo base_url();?>'+'admin/reports/'+url, 
              dataType:'html',
              data:serialize_data,
              success:function(data)
              { 
