                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive" style="border: 1px solid #eee;min-height:500px;">
                    <center>
                      ...
                      <?php $this->load->view('admin/product/addedit_view');?>
                    </center>

                        <form action="<?php echo base_url();?>admin/product/multiselect_action" method="post" name="myform" id="myform">
...
<script type="text/javascript" src="<?php echo base_url();?>backend_assets/plugins/bootstrap-wysiwyg/js/bootstrap-wysihtml5-0.0.2.js"></script>
    ...
    function format ( d )
    {
           ...
           return '<div class="panel widget light-widget" style="box-shadow:-2px 5px 17px #ccc !important;">'+
            ...
            '<div class="panel-body">'+
                    '<span style="font-size:20px;font-weight:bold;margin-left:40%;">Product Detail</span><br><br>'+                   
    ...
    var dt = $('#example').DataTable( {
       oLanguage: {
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo base_url();?>admin/product/get_ajaxdataObjects",
        "columns": [
            {
...
function change_status(Id)
{
      ...
      if(done == true)
      {
          var pageurl_new = '<?php echo base_url();?>'+'admin/product/change_status/'+Id;
...
function delete_confirm(userId)
{
      ...
      if(done == true)
      {
          var pageurl_new = '<?php echo base_url();?>'+'admin/product/delete_confirm/'+userId;
          window.location.href = pageurl_new;
      }
      else
      {
...
$(document).ready(function()
{
          ...
          }).done(function(responce)
           {
              ...
              else
              {
                  if(data.status=='success')
                  {
                         ...
                         if(data.for == 'add')
                                    {
                                      window.location.href = BASEURL+'admin/product/setFlashdata/add';
                                    }
                                    else
                                    {
                                      window.location.href = BASEURL+'admin/product/setFlashdata/edit';
                                    }
                  }
                  else
                  {
  ...
  {   
    BASEURL='<?php echo base_url();?>';
       var pageurl_new = BASEURL+'admin/product/edit_product/'+Id;
       $.ajax({
          url: pageurl_new,
       }).done(function(responce)
       {
