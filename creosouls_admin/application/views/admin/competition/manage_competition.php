              ...
              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive" style="border: 1px solid #eee;min-height:500px;">
                    <center>
                      <?php $this->load->view('admin/competition/addedit_view');?>
                      <?php $this->load->view('admin/competition/ratings_view');?>
                    </center>
                      <button id="addInstitute" style="float:right;margin-bottom:10px;" class="btn btn-primary" onclick="getAutocomplete();"  data-toggle="modal" data-target="#myModal">Add Competition</button>
...
/*  '<div class="row mgbt-xs-10">'+
    ...
    var dt = $('#example').DataTable( {
       oLanguage: {
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo base_url();?>admin/competition/get_ajaxdataObjects",
        "columns": [
            {
                   	...
                   	pageName:
						{
                           ...
                           ctype: "Competition Type is required"
                           },
