...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade" style="display: none;">
      <div class="modal-dialog">
             <div class="modal-content">
                ...
                <?php $zoneList = $this->modelbasic->getSelectedData('zone_list','*');  ?>
                <div class="label-wrapper ">
                <label class="control-label" for="instituteName">Select Zone</label> (<span class="requiredClass"> * </span>)
                </div>
                <div class="vd_input-wrapper light-theme">
                  <select  class="form-control" name="zone" id="zone" onchange="getRegionList(this)">
               ...
               <div class="label-wrapper ">
                  <label class="control-label" for="instituteName">Select Region</label>(<span class="requiredClass"> * </span>)
                </div>
                <div class="vd_input-wrapper light-theme" id="zone-input-wrapper">
                   <select id="region" name="region" class="form-control" onchange="getcompetition_idList(this)">
              ...
              <div class="vd_input-wrapper light-theme">
                <select  class="form-control" name="competition_id[]" id="competition_id" multiple="">
      ...
      <span style="color: green;">(Note:- If checked, then competition is category wise winners for all Users of institute only. otherwise for institute only or open for all)</span>                                                 </div>
      <br/>
      ...
      <br/>
       ...
       <br/>
       <span style="color: green; float: left;">(Note:- Click Add jury button to add new jury members)</span>
       ...
       <div class="label-wrapper">
			...
			<div class="vd_input-wrapper light-theme" id="rule-input-wrapper" >
				<textarea placeholder="Rules" name="rule" class="required" id="wysiwyghtml" class="width-100 form-control"  rows="15"></textarea>
			</div>
			<br/>
                   <!--    <div class="label-wrapper">
                         <label class="control-label " for="contactNo">Contact No</label> (<span class="requiredClass"> * </span>)
                       </div>
                       <div class="vd_input-wrapper light-theme" id="contactNo-input-wrapper" > <span class="menu-icon"> <i class="fa fa-phone"></i> </span>
...
<!-- <?php if($this->session->userdata('admin_level') ==2 || $this->session->userdata('admin_level') ==3){ ?>
                        <div class="label-wrapper ">
                       ...
                       <div class="vd_input-wrapper light-theme" id="open_for_all-input-wrapper">
						 ...
						 <span style="color: green;">(Note:- If checked, then competition open for all Users. otherwise for institute users)</span></div>
					   <br/>
             ...
             <?php } ?> -->
					  ...
					  <!--  <?php if($this->session->userdata('admin_level')==1)
					    { ?>
                          ...
                          <div class="institute_div label-wrapper">
                         <label class="control-label " for="institute_name">Institute Name</label> (<span class="requiredClass"> * </span>)
                       </div>
                       <div class="institute_div vd_input-wrapper light-theme" id="institute_name-input-wrapper" > <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                         <input type="text" placeholder="Try typing 'Institute Name'" autocomplete="off" id="institute_name" name="institute_name" class="required">
                       </div>
                       <div  id="error1" class="institute_div" style="color: #f85d2c;float: left;"></div>
                       <br />
                       <?php } ?> -->
          ...
          <input type="checkbox" data-rel="switch" data-size="mini" data-wrapper-class="blue" id="certificate" name="certificate" data-on-text="Yes" data-off-text="No" checked="">
				...
				<div class="vd_input-wrapper light-theme" id="winnerEmail-input-wrapper" >
					<textarea placeholder="Rules" name="winnerEmail" id="elm1" rows="15" cols="10" style="width:100%" class="myTextEditor width-100 form-control"></textarea>
                       ...
                       <div class="vd_input-wrapper light-theme" id="competitionLogo-input-wrapper" > <span class="menu-icon"></span>
                   ...
                   <!--       <div class="avatar-view" title="Change the avatar">
                      ...
                      <!-- <br/>
                       <div class="label-wrapper">
                         <label class="control-label " for="csvUsers">Import Users</label>
                       </div>
                       <div class="vd_input-wrapper light-theme" id="csvUsers-input-wrapper" > <span class="menu-icon"></span>
                         <input type="file" placeholder="Cover Picture image." id="csvUsers" name="csvUsers">
                         <span style="color: green; float: left;">(Note:- Allowed file types " csv ", Allowed size 2MB)</span>
                       </div>-->
                     </div>
                   </div>
