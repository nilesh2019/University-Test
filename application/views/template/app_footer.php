    	...
    	<div class="row">
        	<div class="col-lg-12">
            	<ul class="pull-left col-lg-6">
            	 <li>
            	 	 <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo_new.png" alt="logo" title="Home"></a>
