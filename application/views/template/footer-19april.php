    	...
    	<div class="row">
        	<div class="col-lg-12">
            	<ul class="pull-left col-lg-6">
            	 <li>
            	 	 <!-- <a href="<?php //echo base_url();?>"><img src="<?php //echo base_url();?>assets/images/Creosouls_logo_new.png" alt="logo" title="Home"></a> -->
            	 	 <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo_new.png" style="width: 200px; " alt="logo" title="Home"></a>
            	 	 <!--<span style="margin-top: 31px;position: absolute;margin-left: -241px;">Powered By Creonow</span>-->
...
<div class="modal fade" id="myModalForDetailProject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: absolute;right: 5px;color: #7D898F;top: 82px;    font-size: 36px;text-shadow:none;opacity: 1;">
				<span aria-hidden="true">
					&times;
				</span>
			</button>
			<iframe id="myModalForDetailProjectIframe"></iframe>
