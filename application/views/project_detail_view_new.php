							...
							<div class="img_box">
								<a data-toggle="modal" data-target=".bs-example-modal-lg" href="#">
									<?php if(file_exists(file_upload_s3_path().'project/thumb_big/'.$project['image_thumb']) && filesize(file_upload_s3_path().'project/thumb_big/'.$project['image_thumb']) > 0){ ?>
										<img class="img-full" src="<?php echo file_upload_base_url();?>project/thumb_big/<?php echo $project['image_thumb']?>" alt=""/>
										<?php
									}else{ ?>
								...
								<div class="over">
									<div class="image_solid image_strip<?php echo $project['image_id'];?>">
										<?php if($this->session->userdata('front_user_id') != ''){
											$userLike = $this->modelbasic->getValue('project_image_rating_like','id',array('user_id'=>$this->session->userdata('front_user_id'),'project_image_id'=>$project['image_id'],'image_like'=>1));
										}else{
											$userLike = '';
										}
										$like = $this->modelbasic->count_all_only('project_image_rating_like',array('project_image_id'=>$project['image_id'],'image_like'=>1));
										if($userLike !=''){ ?>
													...
													<div class="media">
														<div class="media-left">
															<?php if(file_exists(file_upload_s3_path().'users/thumbs/'.$row['profileImage']) && filesize(file_upload_s3_path().'users/thumbs/'.$row['profileImage']) > 0) { ?>
																...
																<img class="media-object img-circle" src="<?php echo base_url();?>creosouls_admin/backend_assets/img/noimage.jpg" alt="">
																<?php
															} ?>
														</div>
					...
					<div class="media">
						...
						<div class="media-left">
							...
							<?php if(file_exists(file_upload_s3_path().'users/thumbs/'.$project['profileImage']) && filesize(file_upload_s3_path().'users/thumbs/'.$project['profileImage']) > 0){ ?>
								<img class="media-object" src="<?php echo file_upload_base_url();?>users/thumbs/<?php echo $project['profileImage']?>" alt="" style="height: auto!important;">
								<?php
							}else{ ?>
								<img class="media-object" src="<?php echo base_url();?>creosouls_admin/backend_assets/img/noimage.jpg" alt="">
								<?php
							} ?>
							</a>
						</div>
