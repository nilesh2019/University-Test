...
<div class="banner">
	...
	?>
		<img class="img-responsive" src="<?php echo file_upload_base_url();?>institute/coverImage/<?php echo $institute[0]['coverImage'];?>" alt="image">
	<?php }else{?>
		<img class="img-responsive" src="<?php echo base_url();?>assets/images/nobaner.png" alt="image">
	<?php }?>
</div>
			...
			var scrollFunction = function()
			{
				...
				if ($(window).scrollTop() >= mostOfTheWayDown)
				{
					...
					if($("#no_rec").length==0)
					{
						...
						$.ajax(
							{
								url: url+"institute/alumini_more_data",
								data:
								{
										...
										$.each(obj, function(index, element)
											{
												...
												$('#project_div').append('<div class="col-lg-2 col-md-2 col-sm-6 '+div_class+'"><div class="box"><img class="img-responsive  project-img" src="<?php echo file_upload_base_url();?>project/thumbs/'+element.image_thumb+'" alt="image" onclick='+urllink+'><div class="product-overlay"><div class="overlay-content"><div class="top"><div class="proj_name"><a href="<?php echo base_url()?>projectDetail/'+element.projectPageName+'" title="'+element.projectName+'">'+trimmedName+'</a></div><div class="col-lg-12 col-xs-12 padding_none" style="padding-left:6px"><h5>'+element.categoryName+'</h5><span onclick="window.location=<?php echo base_url()?>user/userDetail/'+element.userId+'">'+fixedLengthSter+'</span></div></div><div class="footer"><div class="col-lg-4 col-xs-4"><div class="view" title="Total Views"><i class="fa fa-eye"></i>&nbsp;<span>'+element.view_cnt+'</span></div></div><div class="col-lg-4 col-xs-4">'+userLiked+'</div><div class="col-lg-4 col-xs-4"><div class="photo" title="Total Project Images"><i class="fa fa-picture-o"></i>&nbsp;<span>'+element.imageCount+'</span></div></div></div></div></div></div></div>');
...
$('div.dropdown').hover(function() {
  ...
  $(this).find('.dropdown-menu').stop(true, true).delay(200).fadeOut(500);
	...
	function load_projects(url='',all_project='',creative='',featured='',call_count='',search_term='',institute='',alumini_project_status='')
	{
		...
		$.ajax(
		{
			url: url+"institute/alumini_sort_by",
			data:
			{
				all_project:all_project,creative:creative,featured:featured,call_count:call_count,search_term:search_term,institute:institute,alumini_project_status:alumini_project_status
			},
