...
<head>
	...
	<script src="<?php echo base_url();?>assets/email/jquery-ui.min.js"></script>
	<script src="<?php echo base_url();?>assets/email/main.js"></script>
    <title>Welcome to creosouls </title><!-- Responsive Styles and Valid Styles -->
    <style type="text/css">
	    body{
            width: 100%;
...
<body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<ul id="promail">
	<li>
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2b2e34" style="background-image: url(<?php echo base_url();?>assets/email/img/bg_new.png); background-size: 100% 100%; background-position: top center;" background="<?php echo base_url();?>assets/email/img/bg_new.png" class="main-bg">
		<tr><td height="90" style="font-size: 90px; line-height: 90px;">&nbsp;</td></tr>
		<tr>
			<td>
				<table border="0" align="center" width="450" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container3 bg_color" style="border-top-left-radius: 4px; border-top-right-radius: 4px;">
		...
		<tr>
			<td>
				<table border="0" align="center" width="470" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container2 bg_color" style="border-top-left-radius: 4px; border-top-right-radius: 4px;">
					<tr><td height="3" style="font-size: 3px; line-height: 3px;">&nbsp;</td></tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table border="0" align="center" width="490" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container1 bg_color" style="border-top-left-radius: 4px; border-top-right-radius: 4px;">
					<tr><td height="3" style="font-size: 3px; line-height: 3px;">&nbsp;</td></tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container590 bg_color" style="border-radius: 4px;">
						...
						<td>
							<table border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
			 						<!-- ======= logo ======= -->
									<td align="center">
										<a href="" style="display: block; border-style: none !important; border: 0 !important;" class="editable_img"><img editable="true" mc:edit="logo" width="100" border="0" style="display: block; width: 100px;" src="<?php echo base_url();?>assets/img/creonow_logo.png" alt="logo" /></a>
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td align="center" mc:edit="main-header" style="color: #181c27; font-size: 30px; font-family: 'Oxygen', sans-serif; mso-line-height-rule: exactly; line-height: 30px;" class="title_color main-header">
							<!-- ======= section header ======= -->
							<div class="editable_text" style="line-height: 30px;">
								<span class="text_container">
	        					<multiline>
	        						Welcome To creosouls
	        					</multiline>
								</span>
							</div>
        				</td>
					...
					<tr>
						<td>
							<table border="0" width="440" align="center" cellpadding="0" cellspacing="0" class="container580">
								<tr>
									<td align="center" mc:edit="main-text" style="color: #8d94a3; font-size: 16px; font-family: 'Oxygen', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
										<div class="editable_text" style="line-height: 24px">
											<!-- ======= section text ======= -->
											<span class="text_container">
				        					<multiline>
				        						Thank You, For joining creosouls. A simple, easy to use, platform for creative individuals to showcase their creative work.
				        					</multiline>
											</span>
										</div>
			        				</td>
					...
					<tr>
						<td align="center" style="background-image: url(http://themastermail.com/alerta/notif5/img/divider-bg.png); background-size: 100% 100%; background-position: top center;" background="http://themastermail.com/alerta/notif5/img/divider-bg.png">
							<table border="0" align="center" width="300" cellpadding="0" cellspacing="0" bgcolor="2dabcb" style="border-radius: 50px; box-shadow: 0 2px 0 2px #239bb9;" class="cta-button main_color">
								...
								<tr>
	                				<td align="center" style="color: #ffffff; font-size: 18px; font-family: 'Questrial', sans-serif;" mc:edit="main-button" class="cta-text">
	                					<!-- ======= main section button ======= -->
		                    			<div class="editable_text" style="line-height: 24px;">
		                    				<span class="text_container">
			                    			<a href="<?php echo base_url();?>" style="color: #ffffff; text-decoration: none;"><singleline>Visit creosouls</singleline></a>
		                    				</span>
		                    			</div>
		                    		</td>
	                			</tr>
...
<!--
					<tr>
						<td align="center" mc:edit="unsubscribe" style="color: #8d94a3; font-size: 14px; font-family: 'Questrial', sans-serif; line-height: 22px;" class="text_color">
							<div class="editable_text" style="line-height: 22px;">
								<span class="text_container">
	        						<multiline>
										<a href="" style="color: #8d94a3; text-decoration: none;" class="text_color">Unsubscribe</a>
            						</multiline>
								</span>
							</div>
        				</td>
		...
		<tr>
			<td>
				<table border="0" width="540" align="center" cellpadding="0" cellspacing="0" class="container580">
					<tr>
						<td align="center" mc:edit="copy" style="color: #ffffff; font-size: 14px; font-family: 'Questrial', sans-serif; mso-line-height-rule: exactly; line-height: 30px;" class="text2_color">
							<div class="editable_text" style="line-height: 30px">
								<!-- ======= section text ======= -->
								<span class="text_container">
	        					<multiline>
	        						© 2017 creosouls. All Rights Reserved.
	        					</multiline>
								</span>
							</div>
        				</td>
