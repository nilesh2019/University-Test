   ...
   <div class="container-fluid">
     <div class="row">
       <div class="col-lg-12">
         <ol class="breadcrumb">
           <li>Dashboard</li>
           <li class="active">Jury Competition</li>
         </ol>
       </div>
       </div>
                  ...
                  ?>
                      <div class="col-lg-6 <?php if($i % 2 == 0){ echo 'left';}else{echo 'right';}?>7">
                          <div class="box_jury_proj">
                              <img src="<?php echo file_upload_base_url();?>competition/banner/<?php echo $competition['banner'];?>" alt="image">
                                 <div class="trans">
                                  <div class="col-lg-4 col-xs-12">
                                     ...
                                     <div class="col-lg-12 col-xs-12">
                                      ...
                                      <a style="margin-bottom:10px;" class="btn btn-primary" target="_blank" href="<?php echo base_url();?>competition/get_competition/<?php echo $competition['id'];?>/<?php echo $competition['juryId'];?>">Rate It</a>
                                     </div>
                                     <div class="count">
