...
<div class="banner">
	...
	?>
        ...
        <img class="img-responsive" src="<?php echo file_upload_base_url();?>institute/coverImage/<?php echo $institute['coverImage'];?>" alt="">
	<?php }else{?>
		<img class="img-responsive" src="<?php echo base_url();?>assets/images/Institute_Banner.png" alt="image">
	<?php }?>
</div>
<div class="search_container search_style">
	<div class="container-fluid">
		<div class="row">
            ...
            <img src="<?php echo file_upload_base_url();?>institute/instituteLogo/<?php echo $institute['instituteLogo'];?>" alt="">
					<?php }else{?>
					<img src="<?php echo base_url();?>assets/images/Institute_Logo.png" alt="image">
					<?php }?>
