<?php 
  $this->load->view('template/app_header');
...
<div class="middle">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default TandC"> 
          <!-- Nav tabs -->
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active" id="terms">
              <p>PLEASE CAREFULLY READ THE FOLLOWING TERMS OF USE OF THE WEBSITE. BY ACCESSING AND USING THIS WEBSITE YOU AGREE TO BE BOUND BY THE TERMS OF USE THEREOF. THE TERMS OF USE APPLY TO YOUR USE OF THE WEBSITE AS WELL AS TO THE SERVICES AVAILED THROUGH THIS WEBSITE. IF YOU DO NOT AGREE TO BE BOUND BY THE TERMS OF USE, PLEASE DO NOT ACCESS OR USE THE WEBSITE.</p>
              <p>In using or accessing this website, you are deemed to have read carefully and agreed to the following terms and conditions:</p>
              <p><strong>Aptech Ltd.</strong><strong>,</strong>&nbsp;a company incorporated in India (&ldquo;<strong>Aptech</strong>&rdquo;), operates its website&nbsp;<strong>www.creosouls.com</strong>&nbsp;(the&quot;<strong>Site</strong>&quot;), powered by creonow<sup class="tm">TM</sup> to provide online access to the Site visitor/user (&ldquo;You&rdquo;) to provide content, services, products and other opportunities to You. Where You are using this Site on behalf of a corporate entity, (i) You represent that You have due authority from such corporate entity and (ii) these Terms of Use shall bind such corporate entity as well. By accessing and/or using this Site, You agree to each of the terms and conditions set forth herein (&quot;<strong>Terms of Use</strong>&quot;). Additional terms and conditions including the Privacy Policy and other policies applicable to general and specific areas of this Site may also be posted in relevant areas of the Site. Such additional terms and conditions, together with these Terms of Use, govern Your use of those areas, content, product or services. These Terms of Use, together with applicable additional terms and conditions, disclaimers and policies, are referred to as &ldquo;<strong>Agreement</strong>.&rdquo;</p>
              <p>&nbsp;</p>
              <p><strong>USE OF THE SITE</strong></p>
              <hr />
              <p>You may use the Site; and the information, writings, images, audio, video, multimedia, and/or other works that You see, access, upload or otherwise experience on the Site (singly or collectively, the &quot;<strong>Site Content</strong>&quot;); and the services, products and other opportunities provided in the Site (singly or collectively, the &quot;<strong>Services</strong>&quot;) so long as such purposes are compliant with all applicable laws. You may not use this Site, Site Content or Services for any purposes not intended under this Terms of Use including any e-commerce activities.</p>              
              <p>No right, title or interest in and to any Site Content, whether in whole or in part, is transferred to You, whether as a result of accessing such Site Content or otherwise. creosouls and/ or its licensors reserve all rights, title and interest in and to the intellectual property rights in all Site Content posted on the Site, including for material or any content submitted by You which does not violate any intellectual property rights of the third parties. Except as expressly authorized by the Terms of Use, You may not use, alter, copy, modify, distribute, transmit, or derive another work from any Site Content obtained from the Site.</p>
              ...
              <ul>
                ...
                <li>reproduce, duplicate, copy, sell or exploit for any commercial purpose, or redistribute or publish the Site Content or Services provided by creosouls or obtained from creosouls without obtaining creosouls&rsquo;s express, prior written consent or as permitted by this Terms of Use. This restriction includes any attempt to incorporate any information provided by creosouls into any other directory, product, or service;</li>
                <li>do any act that violates creosouls&rsquo;s intellectual property or intellectual property rights in the Site Content or any intellectual property rights of any third party;</li>
                <li>Upload any information/content/data whatsoever that violate any intellectual property rights of any third party;</li>
                ...
                <li>artificially create  or alter number of views, likes or favourites, vote counts, blog counts, comments, or any other Service or for the purpose of giving or receiving money or other compensation in exchange for votes, or for participating in any other organized effort that in any way artificially alters the results of Services;</li>
                <li>use the Site to store and/or display and/or publish any adult or offensive content, which without limitation includes all pornography, erotic images, or otherwise lewd or obscene content. The designation of "adult content" is left entirely to creosouls&rsquo;s discretion;</li>
                <li>threatens the unity, security or sovereignty of any country;</li>
              ...
              <p>You shall not share Your login name and password with any other individual or corporate entity and You will not permit any other person or entity to use the Site via Your login name and password either concurrently with You or otherwise. creosouls reserves the right to refuse, disable or terminate Your Site access or account, whether in part or in full, if in its sole discretion at any time it is found that You have been sharing Your password or using someone else&rsquo;s password in any unauthorized way or have been using such password for any illegal or unauthorized purpose or You have infringed or likely to infringe the copyrights or other intellectual property rights of creosouls and/or other third party.</p>
              <p>&nbsp;</p>              
              <p><strong>MY Page &amp; Account Setting</strong></p>
              <hr />
              <p>You can personalize Your use of the Site through &ldquo;MY Page&rdquo;&amp; &ldquo;Account Setting&rdquo;, features available exclusively to You who have registered/ subscribed to the Site.</p>
              <p>You agree that creosouls shall have the right to monitor, review all portions of User Content and may remove any and all such User Content if in the reasonable opinion of creosouls such User Content violates the Terms of Use or is objectionable in any manner.</p>   
              ...
              <hr />
              <p>creonow respects the intellectual property rights of others, and we request our visitors and users to do the same. The Site and the Site Content is protected by applicable intellectual property laws and international treaties.</p>
              <p>Except as permitted under these Terms of Use or unless expressly authorized by creonow, You agree not to reproduce, modify, sell, distribute, mirror, frame, republish, download, transmit, or create derivative works of the Site Content, in whole or in part, by any means. You must not remove or modify any copyright or trademark notice, or other notice of ownership. You shall abide by the Terms of Use and the Agreement while using the Site Content on the Site. Any other use is prohibited and will constitute an infringement of the proprietary rights of creonow and/ or the relevant owner.</p>
              <p>creonow and/or its licensors assert all proprietary rights in and to all names and trademarks contained on the Site. The name creonow is the trademark and copyright (or any other intellectual property right) of creonow, the owner of the Site. Any use of the creonow&rsquo;s trademarks or copyright in connection with any product or service that does not belong to the creonow, unless otherwise authorized in a written license agreement, will constitute an infringement upon the trademark and copyright (or any other such intellectual property right) and may be actionable under the applicable laws.</p>
              ...
              <p>creosouls ASSUMES NO RESPONSIBILITY AND/OR LIABILITY WITH RESPECT TO ANY USER CONTENT WHICH YOU MAY POST ON THE SITE AND YOU ARE SOLELY RESPONSIBLE AND LIABLE IN RESPECT OF SUCH USER CONTENT.</p>
              <p>&nbsp;</p>
              ...
              <p>IN ANY EVENT creosouls&rsquo;S LIABILITY ARISING OUT OF THIS TERMS OF USE AND/ OR AGREEMENT SHALL NOT EXCEED THE AMOUNT ACTUALLY PAID BY YOU AS SUBSCRIPTION FEE AT THE TIME OF REGISTRATION/ SUBSCRIPTION TO THE SITE.</p>
              <p><strong>INDEMNIFICATION</strong></p>
              <hr />
              <p>You agree to defend, hold harmless and indemnify creosouls, its directors and officers from and against any and all losses, costs, expenses, damages or other liabilities incurred by creosouls and/or its directors and officers, from and against any cost, liability, loss, damage, cause of action, claim, suit, proceeding, demand or action brought by a third party against creosouls and/or its directors and officers, due to or arising out of or in connection with Your use of the Services, or Site Content, any User Content which You may post on the Site or Your breach of any provision of Terms of Use or Agreement; or any negligent or intentional wrongdoing on the Site.</p>
              <p>Any such indemnification shall be conditioned on our: (a) notifying You in writing of any such claim, demand, action, cost, liability, loss or threat of any thereof; (b) cooperating with You in the defense or settlement thereof; and (c) allowing You to control such defense or settlement. We shall be entitled to participate in such defense through our own counsel at Your cost and expense.</p>
              <p>&nbsp;</p>
              <p><strong>NOTIFICATION OF CHANGES</strong></p>
              <hr />
              <p>creosouls reserves the right to modify this Terms of Use or the Agreement at any time without giving You prior notice. Your use of the Site following any such modification constitutes Your agreement to follow and be bound by this Terms of Use or the Agreement as may be modified from time to time. The last date this Terms of Use was revised may be set forth at the end of this Terms of Use. Your continued use of the Site after notice of any change to the Terms of Use will be deemed to be Your consent to the amended terms.</p>
              <p>&nbsp;</p>
              ...
              <p>Upon termination or suspension, regardless of the reasons therefore, Your right to use the Content, Site or Services immediately ceases, and You acknowledge and agree that we may immediately deactivate or delete Your account (including your subscription) and all related information and files in Your account and/or bar any further access to such files or this site. You shall not be entitled to any refund of the subscription fee paid by You at the time of subscribing to creosouls&rsquo;s Site, Content or Services. We shall not be liable to You or any third party for any claims or damages arising out of any termination or suspension or any other actions taken by us in connection with such termination or suspension.</p>
              <p>&nbsp;</p>
              <p><strong>GOVERNING LAW AND JURISDICTION</strong></p>
              <hr />
              <p>The Agreement is governed by the laws of India. By accessing the Site, You consent to the exclusive jurisdiction of Mumbai <a name="_GoBack"></a>courts, in India in all disputes arising out of or relating to the use of the Site Content or Services. Use of the Site is unauthorized in any jurisdiction that does not give effect to all provisions of the Agreement, including without limitation, this paragraph.</p>
              <p>&nbsp;</p>
              ...
              <p>If You have any questions or concerns regarding the Terms of Use, please contact us at <a href="mailto:<?php echo $emailFrom;?>"><?php echo $emailFrom;?></a></p>
            </div>
...
<?php $this->load->view('template/app_footer');?>
<?php 
if($current_tab=='policy')
{
?>
<script>
  $('#trm').removeClass('active');
  $('#terms').removeClass('in active');
  $('#prvc').addClass('active');
  $('#PRIVACY_POLICY').addClass('in active');
</script>
<?php }?>