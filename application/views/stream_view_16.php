                  ...
                  foreach($institute as $row){
                    ...
                    <div class="job-info">
                      <a href="<?php echo base_url().$row['pageName'];?>" >
                        ...
                        {
                          ?>
                          <img class="inst_cover_image" src="<?php echo file_upload_base_url();?>institute/instituteLogo/<?php echo $row['instituteLogo'];?>" alt="image">
                          <?php
                        }
                        else
                        {
...
<!-- Advertisement -->
  ...
  <?php if(!empty($blog)){?>
    ...
    <div class="user-profy">
        ...
        <ul class="bmeta">
          <li><span><img src="<?php echo base_url();?>assets/custom-time-line_test_imgs/clock.png" alt="">&nbsp;<?php echo get_time_ago( strtotime($row['created']) ); ?></span></li>
  ...
  if(!empty($blog_projects)){
     ...
     if(isset($_GET['sort']) && $_GET['sort'] == 2){
         ...
         $blog_projects = $getFollowingUsersLikedProjects;
          $lcomments = array();
              foreach ($blog_projects as $key => $row)
              {
                //$price[$key]['name'] = $row->name;
            ...
            <div class="post_topbar">
              <div class="usy-dt">
                ...
                <div class="usy-name">
                  ...
                  <span><img src="images/clock.png" alt="image"><?php echo get_time_ago( strtotime($row['created']) ); ?></span>
                </div>
              </div>
            ...
            <a href="<?php echo base_url();?>user/userDetail/<?php echo $row['userId']?>">
              ...
              if(file_exists(file_upload_s3_path().'users/thumbs/'.$row['profileImage']) && filesize(file_upload_s3_path().'users/thumbs/'.$row['profileImage']) > 0)   {
                ...
                <div class="usy-name">
                  ...
                  <span><img src="<?php echo base_url();?>assets/custom-time-line_test_imgs/clock.png" alt="image"><?php echo get_time_ago( strtotime($row['created']) ); ?></span>
                </div>
...
<?php }  ?>
       ...
       <div class="process-comm" style="display: none" id="showSpinner">
                      <div class="spinner">
...
<div class="widget suggestions full-width event-lists">
  ...
  <div class="suggestions-list">
    ...
    if(!empty($eventLive)){
      foreach(array_slice($eventLive,0,2) as $row){
        ...
        <div class="suggestion-usds">
          <a href="<?php echo base_url();?>event/show_event/<?php echo $row['id'];?>">
            <img class="media-object" src="<?php echo file_upload_base_url();?>event/banner/thumbs/<?php echo $row['banner'];?>" alt="">
            <div class="sgt-text">
          ...
          <div class="suggestion-usds">
            <div class="list-of-comp">
              <a href="<?php echo base_url();?>competition/<?php echo $row['pageName'];?>">
                <img alt="image" src="http://via.placeholder.com/40x40" class="com-img">
                <?php
                $atr = $row['name'];
                if(strlen($atr) > 38){
                  $dot = '..';
    ...
    $.ajax(

          {
              url: url+"stream/timeinline_more_data",
                data:
                {
                  sliceCount:page,timelinArray:tmAry
                },
                type: "POST",
